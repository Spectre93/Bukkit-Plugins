...
/* Written by Adam753 for the Bukkit community.
 * Feel free to use or distribute as you need; I'm not going to sue anyone.
 * 
 * I only wrote this class for the convenience of people whose existing plugins/methods will be broken by the 1.7 update.
 * You should try to use the Material enum where possible, as IDs are no longer core to Bukkit.
 * Please PM me on Bukkit.org with any issues.
 */
